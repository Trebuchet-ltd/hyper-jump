...
class DataStore {
  constructor() {
    // saved checkpoint
    this.snapshot = {}; // deltas from snapshot in order

    this.log = []; // current store state

    this.state = {};
    this.state['objects'] = {}; // TODO: additional child that may need to be initialized at startup
    // track statistics of usage
    // TODO: integrate with the functions to track usage stats
    // TODO: integrate optional timing profiling

    this.stats = {}; // ttl timers for scheduled events

    this.timers = {};
    this.timers['lock'] = {};
    this.timers['remove'] = {}; // three examples of metadata:
  ...
  clear() {
    ...
    this.snapshot = this.state; // TODO: finish this function
