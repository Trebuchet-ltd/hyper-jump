"use strict"; // TODO: add ping pong heartbeart to keep connections alive
...
export class Client {
  constructor(heartbeat = 30000) {
    ...
    this.ws = null; // this.subs = new evtPubSub();
  } // TODO: verify this is working


  heartbeat() {
    clearTimeout(this.pingTimeout); // Delay should be equal to the interval at which your server
    // sends out pings plus a conservative assumption of the latency.

    this.pingTimeout = setTimeout(() => {// this.close(); // i.e. revisit this...
  ...
  connect(ip, port) {
    try {
      ...
      console.log("wss://" + ip + ":" + port); // function reconnect
