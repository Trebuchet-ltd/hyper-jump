...
export function ab2str(buf) {
  var rawBuf = String.fromCharCode.apply(null, new Uint8Array(buf)); // we are using json objects everywhere
...
export function corelink_message(type, data) {
  ...
  var json_bytes = str2ab(JSON.stringify(message)); // var jsonStr = JSON.stringify(message);
