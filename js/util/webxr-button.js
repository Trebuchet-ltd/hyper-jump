...
const READY_TO_PRESENT = "ready"; // In presentation mode

const PRESENTING = "presenting";
const PRESENTING_FULLSCREEN = "presenting-fullscreen"; // Checking device availability

const PREPARING = "preparing"; // Errors
