...
const extractedGltfFilename = './examples/classroom0126/classroom0126.gltf'; // Perform the conversion; output paths are overwritten

ConvertGLBtoGltf(inputGlb, extractedGltfFilename); // let gltfContent = fs.readFileSync(extractedGltfFilename, 'utf8');
